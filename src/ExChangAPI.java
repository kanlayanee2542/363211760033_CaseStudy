...
public class ExChangAPI {
    //class attributes
    private String result;
    private int time_last_update_unix;
    private String time_last_update_utc;
    private int time_next_update_unic;
    private String time_next_update_utc;
    private String base_code;
    private JSONObject eachRate;

    private static String  url_API = "https://v6.exchangerate-api.com/v6/557555bd5bd977dda21ccc32/latest/";
